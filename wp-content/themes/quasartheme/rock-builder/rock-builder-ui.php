...
function rockthemes_pb_make_modals($arr){
	...
	foreach($arr as $modal){
		...
		*/
			...
			$return .= 
			'<div id="'.$id.'" modalType="toggles" class="modal container hide fade" >
								<div class="modal-header">
...
function xr_make_gallery_modal($modal=null,$id=null){
	...
	$return = '
	<div id="'.$id.'" class="modal container hide fade" tabindex="-1" role="dialog" aria-labelledby="Gallery" aria-hidden="true">
		<div class="modal-header">
			<div class="close builder-close"><i class="fa fa-times"></i></div>
			<h3>Gallery</h3>
		</div>
...
function xr_make_teammembers_modal($modal=null,$id=null){
	...
	$return .= '
		<div id="'.$id.'" modalType="teammembers" class="modal container hide fade" >
			<div class="modal-header">
				<div class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></div>
...
function rock_make_single_teammembers_modal($teammembersObj=null, $id=null){
	...
	$return = '
		<div id="teammembers-single-modal" modalType="teammembers" class="modal container hide fade">
			<div class="modal-header">
...
function xr_make_socialicons_modal($modal=null,$id=null){
	...
	$script = '';
		...
		$return .= 
			'<div id="'.$id.'" modalType="socialicons" class="modal container hide fade '.(!$remove_modal_after ? '' : 'external-modal-call' ).'" >
				<div class="modal-header">
...
function rock_make_single_socialicons_modal($socialiconsObj=null, $id=null){
	...
	$return = '
		<div id="socialicons-single-modal" modalType="socialicons" class="modal container hide fade">
			<div class="modal-header">
...
function xr_make_testimonialsbuilder_modal($modal=null,$id=null){
	...
	$testimonialsString = '												
		...
		if(!$is_ajax){
			...
			$return .= 
			'<div id="'.$id.'" modalType="testimonialsbuilder" class="modal container hide fade" >
								<div class="modal-header">
									<div class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></div>
...
function rock_make_single_testimonialsbuilder_modal($testimonialsbuilderObj=null, $id=null){
	...
	$return = '<div id="testimonialsbuilder-single-modal" modalType="testimonialsbuilder" class="modal container hide fade" tabindex="-1" role="dialog" aria-labelledby="Testimonials Builder" aria-hidden="true" data-focus-on="input:first">
								<div class="modal-header">
...
function xr_make_alertbox_modal($modal=null,$id=null){
	...
	$return = '
	<div id="'.$id.'" class="modal container hide fade" tabindex="-1" role="dialog" aria-labelledby="Alert Box" aria-hidden="true">
		<div class="modal-header">
			<div class="close builder-close"><i class="fa fa-times"></i></div>
			<h3>Alert Box</h3>
		</div>
...
function xr_make_promotionbox_modal($modal=null,$id=null){
	...
	$return = '
	<div id="'.$id.'" class="modal container hide fade" tabindex="-1" role="dialog" aria-labelledby="Promotion Box" aria-hidden="true">
		<div class="modal-header">
			<div class="close builder-close"><i class="fa fa-times"></i></div>
			<h3>Promotion Box</h3>
		</div>
...
function xr_make_googlemap_modal($modal=null,$id=null){
	...
	$return = '
	<div id="'.$id.'" class="modal container hide fade" tabindex="-1" role="dialog" aria-labelledby="Google Map" aria-hidden="true">
		<div class="modal-header">
			<div class="close builder-close"><i class="fa fa-times"></i></div>
			<h3>Google Map</h3>
		</div>
...
function xr_make_rockformbuilder_modal($modal=null,$id=null){
	...
	$return = '
	<div id="'.$id.'" class="modal container hide fade" tabindex="-1" role="dialog" aria-labelledby="Rock Form Builder" aria-hidden="true">
		<div class="modal-header">
			<div class="close builder-close"><i class="fa fa-times"></i></div>
...
function xr_make_hr_modal($modal=null,$id=null){
	...
	$return = '
	<div id="'.$id.'" class="modal container hide fade" tabindex="-1" role="dialog" aria-labelledby="Skill" aria-hidden="true">
		<div class="modal-header">
			<div class="close builder-close"><i class="fa fa-times"></i></div>
...
function xr_make_button_modal($modal=null,$id=null){
	...
	*/
	...
	$return = '
	<div id="'.$id.'" class="modal container hide fade '.(!$remove_modal_after ? '' : 'external-modal-call' ).'" tabindex="-1" role="dialog" aria-labelledby="Button" aria-hidden="true">
		<div class="modal-header">
			<div class="close '.(!$remove_modal_after ? 'builder-close' : 'close-grid-modal' ).'"><i class="fa fa-times"></i></div>
			<h3>Button</h3>
		</div>
...
function rockthemes_pb_make_specialgridblock_modal($modal=null,$id=null){
	...
	*/
	...
	$return = '
	<div id="'.$id.'" class="modal container hide fade grid-modal" tabindex="-1" role="dialog" aria-labelledby="Grid" aria-hidden="true">
		<div class="modal-header">
			<div class="close builder-close"><i class="fa fa-times"></i></div>
...
function xr_make_iconictext_modal($modal=null,$id=null){
	...
	$return = '';	
			...
			$return .= 
			'<div id="'.$id.'" modalType="iconictext" class="modal container hide fade" tabindex="-1">
								<div class="modal-header">
									<div class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></div>
...
function xr_make_tabs_modal($modal=null,$id=null){
	...
	$tabsString = '												
		...
		if(!$is_ajax){
			...
			$return .= 
			'<div id="'.$id.'" modalType="tabs" class="modal container hide fade" >
								<div class="modal-header">
									<div class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></div>
					  				<h3>Add tab</h3>
								</div>
...
function rock_make_single_tab_modal($tabObj=null, $id=null){
	...
	$return = '<div id="tabs-single-modal" modalType="tabs" class="modal container hide fade" tabindex="-1" role="dialog" style="width:1024px; margin-left:-512px;" aria-labelledby="Tabs" aria-hidden="true" data-focus-on="input:first">
								<div class="modal-header">
...
function rock_icon_list_modal(){
	...
	$return = '<div id="rock-icon-list-modal" modalType="iconlist" class="modal container hide fade" tabindex="-1" role="dialog" aria-labelledby="Tabs" aria-hidden="true">
								<div class="modal-header">
									<div class="close close-tab-single"><i class="fa fa-times"></i></div>
...
function rockthemes_pb_element_list_modal(){
	...
	$modal = '
		<div id="rockthemes-pb-elements-modal" class="modal container hide">
			<div class="modal-header">
				<div class="close" data-dismiss="modal" aria-hidden="true"><i class="fa fa-times"></i></div>
