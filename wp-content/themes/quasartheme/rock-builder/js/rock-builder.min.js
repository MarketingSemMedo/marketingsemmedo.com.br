jQuery(document).ready(function() {
  function l(a) {
    for (var b = a.attr("id"), c = 0;c < g.length;c++) {
      if (g[c].id == b) {
        g[c].obj = null;
        g[c].obj = a;
        a.find(".rock-tinymce-container").length && (q(a.attr("id")), window.tinyMCE.execCommand("mceRemoveEditor", !1, a.attr("id").replace("#", "") + "-editor"), wpActiveEditor = "content");
        jQuery("#" + b).modal("hide");
        break;
      }
    }
  ...
  function q(a) {
    var b;
    b = a;
    f ? ("string" === typeof a && -1 < a.indexOf("#") && (a = a.replace("#", "")), (a = k(a)) || (a = jQuery(b))) : a = jQuery("#" + a);
  ...
  function N(a, b) {
    ...
    jQuery(document).trigger("rocthemes:modal_added_runtime", [h]);
  }
  function pa() {
  ...
  function G(a) {
    C++;
    3 <= C && (jQuery(document).trigger("rocthemes:modal_added_runtime", [a]), C = 0);
  }
  function O(a) {
    ...
    if (a.find(".category_taxonomy option").length == b.category.length) {
      ...
      for (var d = !1, c = 0;c < b.category.length;c++) {
        if (-1 < b.category[c].toString().indexOf(",")) {
          d = !0;
          break;
        }
  ...
  function R(a) {
    ...
    b.find(".table-elem").each(function(a) {
      var h = {};
      h.packageName = jQuery(this).find(".pt-package-name").val();
      h.packageDetail = jQuery(this).find(".pt-package-detail").val();
      h.packageFeatured = jQuery(this).find(".set_featured").is(":checked") ? "true" : "false";
      h.packageTime = jQuery(this).find(".pt-package-time").val();
      h.packagePrice = jQuery(this).find(".price").val();
      h.featuredText = c.featuredText;
      h.packageOptions = [];
      var f = " ";
      jQuery(this).find(".new-option").each(function(a) {
        ...
        h.packageOptions.push(c);
        f += "option_name" + a + '="' + c.name + '" option_value' + a + '="' + c.value + '" icon_class' + a + '="' + c.icon_class + '" icon_url="' + c.icon_url + '" ';
      });
      h.button_json_data = jQuery(this).find(".button_json_data").val();
      h.button_shortcode = jQuery(this).find(".button_shortcode").val();
      d += '[rockthemes_pricingtable_table show_details="' + c.show_details_in_tables + '" package_name="' + h.packageName + '" package_detail="' + h.packageDetail + '" package_featured="' + h.packageFeatured + '" package_time="' + h.packageTime + '" package_price="' + h.packagePrice + '" ';
      d += 'featured_text="' + h.featuredText + '" ';
      d += f + "]";
      d += h.button_shortcode + "[/rockthemes_pricingtable_table]";
      c.tables.push(h);
    });
    a = a + d + "[/rockthemes_pricingtable]";
    return {data:c, shortcode:a};
  }
  function S(a) {
    a = a.replace("elem-", "modal-");
    a = f ? k(a) : jQuery("#" + a);
  ...
  function U(a) {
    ...
    a.find(".toggles-list .toggles-block").each(function(a, e) {
      var h = jQuery(this).find(".secret-desc").attr("icon_class"), f = jQuery(this).find(".secret-desc").attr("icon_url");
      c += '[rockthemes_toggles_single use_shadow="' + b.use_shadow + '" title="' + jQuery(this).find(".secret-desc").attr("toggle-title") + '" icon_class="' + h + '" icon_url="' + f + '"]';
      c += jQuery(this).find(".secret-desc").html() + "[/rockthemes_toggles_single]";
      b.toggles.push({title:jQuery(this).find(".secret-desc").attr("toggle-title"), text:jQuery(this).find(".secret-desc").html(), icon_class:h, icon_url:f});
    });
  ...
  function V(a) {
    ...
    a.find(".tabs-list .tabs-block").each(function(a, e) {
      var h = jQuery(this).find(".secret-desc").attr("icon_class"), f = jQuery(this).find(".secret-desc").attr("icon_url");
      c += '[rockthemes_tabs_single title="' + jQuery(this).find(".secret-desc").attr("tab-title") + '" icon_class="' + h + '" icon_url="' + f + '"]';
      c += jQuery(this).find(".secret-desc").html() + "[/rockthemes_tabs_single]";
      b.tabs.push({title:jQuery(this).find(".secret-desc").attr("tab-title"), text:jQuery(this).find(".secret-desc").html(), icon_class:h, icon_url:f});
    });
  ...
  function W(a) {
    ...
    c.link_details = X(b.find(".link_select"));
    c.shortcode = "";
  ...
  function D(a) {
    ...
    a.link_details = X(b.find(".link_select"));
    a.shortcode = "";
  ...
  function da(a) {
    ...
    a.find(".testimonialsbuilder-list .testimonialsbuilder-block").each(function(a, e) {
      var h = jQuery(this).find(".secret-desc").attr("company");
      c += '[rockthemes_testimonials_builder_single name="' + jQuery(this).find(".secret-desc").attr("testimonialsbuilder-title") + '" company="' + h + '"]';
      c += jQuery(this).find(".secret-desc").html() + "[/rockthemes_testimonials_builder_single]";
      b.testimonials.push({title:jQuery(this).find(".secret-desc").attr("testimonialsbuilder-title"), text:jQuery(this).find(".secret-desc").html(), company:h});
    });
  ...
  function ea(a) {
    ...
    a.find(".teammembers-list .teammembers-block").each(function(a, e) {
      var h = jQuery(this).find(".secret-desc").attr("company"), f = jQuery(this).find(".secret-desc").attr("external_url"), k = jQuery(this).find(".social_data").html(), l = jQuery(this).find(".social_shortcode").html(), g = jQuery(this).find(".secret-desc").attr("member_image_url");
      c += '[rockthemes_team_members_single name="' + jQuery(this).find(".secret-desc").attr("teammembers-title") + '" company="' + h + '" external_url="' + f + '" member_image_url="' + g + '" social_icons_title="' + b.social_icons_title + '"]';
      var m = jQuery(this).find(".secret-desc").html() + "&rss;" + l + "&rse;";
      c += m + "[/rockthemes_team_members_single]";
      b.teammembers.push({title:jQuery(this).find(".secret-desc").attr("teammembers-title"), text:jQuery(this).find(".secret-desc").html(), company:h, external_url:f, member_image_url:g, social_data:k, social_shortcode:l});
    });
  ...
  function y(a, b, c) {
    ...
    jQuery(".gridster li.gridsterli ").each(function() {
      ...
      if (jQuery(this).hasClass("specialgridblock")) {
        if (jQuery(this).hasClass("block-open")) {
          var b = {id:jQuery(this).attr("id"), data:ta(jQuery(this).attr("id"))};
          ...
          b = k("modal-" + jQuery(this).attr("id").toString().replace("close-", "")).find(".avoid_sidebar").find(":selected").val(), d.push({id:jQuery(this).attr("id"), grid_data:{data:{data:{avoidSidebar:b}}}, col:parseInt(jQuery(this).attr("data-col"), 10), row:parseInt(jQuery(this).attr("data-row"), 10), size_x:parseInt(jQuery(this).attr("data-sizex"), 10), size_y:parseInt(jQuery(this).attr("data-sizey"), 10), shortcode:"[/rockthemes_specialgridblock]", special_grid_block:"yes", special_grid_block_open:"no"}), 
          e += "[/rockthemes_specialgridblock]";
        }
      } else {
        b = {id:jQuery(this).attr("id"), data:va(jQuery(this).attr("id"))}, d.push({id:jQuery(this).attr("id"), grid_data:b, col:parseInt(jQuery(this).attr("data-col"), 10), row:parseInt(jQuery(this).attr("data-row"), 10), size_x:parseInt(jQuery(this).attr("data-sizex"), 10), size_y:parseInt(jQuery(this).attr("data-sizey"), 10), elems:a, special_grid_block:"no"});
      }
    });
    if (1 == b) {
      a = [];
      a = d.sort(wa);
      b = c = 1;
      for (var l = !1, g = '<div class="row">', m = 0;m < a.length;m++) {
        var p = a[m];
        "yes" == a[m].special_grid_block ? (g += a[m].shortcode, "full_width_slider" == p.grid_data.data.data.grid_special_width_details && (l = "yes" == p.special_grid_block_open ? !0 : !1)) : parseInt(p.row) !== parseInt(c) && (c = p.row, 12 >= b && 1 !== b && (g += '<div class="large-' + (13 - b) + ' columns"></div>'), l || (g += '</div><div class="row">'), b = 1);
        l || (b < parseInt(p.col) && 1 !== b ? (g += '<div class="large-' + p.size_x + " large-offset-" + (parseInt(p.col) - b) + ' columns">', b = parseInt(p.size_x) + parseInt(p.col)) : (g += '<div class="large-' + p.size_x + ' columns">', b += parseInt(p.size_x)));
        if ("undefined" != typeof p.elems) {
          for (var n = 0;n < p.elems.length;n++) {
            g += p.elems[n].desc;
          }
        }
        g += "</div>";
    ...
    if (1 == c) {
      return a = {}, a.elems = d, a._builder_in_use = b, a._featured_image_in_builder = h, a;
    }
    jQuery.post(rockAjax.ajaxurl, {postID:a, serializedArray:JSON.stringify(d), _builder_in_use:b, featuredInBuilder:h, action:"rockAjax-save"}, function(a) {
  ...
  jQuery(document).on("click", "#toggle_page_builder", function() {
    "off" == jQuery(this).attr("mode") ? (jQuery("#wp-content-wrap.wp-editor-wrap").hasClass("tmce-active") || jQuery("#wp-content-editor-tools #content-tmce").trigger("click"), jQuery("#postdivrich").css({visibility:"hidden", position:"relative", height:"0px", overflow:"hidden", transform:"translateX(-3000px)"}), jQuery("#custom_page").css("display", "block"), jQuery(this).attr("mode", "on"), jQuery(this).val("Close Rock Page Builder")) : (jQuery("#postdivrich").css({visibility:"", position:"", 
    height:"", overflow:"", transform:""}), jQuery("#custom_page").css("display", "none"), jQuery(this).attr("mode", "off"), jQuery(this).val("Open Rock Page Builder"));
  });
  (function() {
    jQuery("#postdivrich").before('<input autocomplete="off" type="button" class="button button-primary" style="margin-top:10px; margin-bottom:10px;" id="toggle_page_builder" name="toggle_page_builder"mode="off" value="Open Rock Page Builder" />');
    if ("true" == (jQuery("#_builder_in_use").is(":checked") ? "true" : "false")) {
      if (jQuery("#wp-content-wrap.wp-editor-wrap").hasClass("tmce-active")) {
        ...
        var a = setInterval(function() {
          "undefined" == typeof tinyMCE || null != tinyMCE.activeEditor && 0 == tinyMCE.activeEditor.isHidden() || (clearInterval(a), jQuery("#wp-content-editor-tools #content-tmce").trigger("click"), setTimeout(function() {
            jQuery("#toggle_page_builder").trigger("click");
          }, 100));
        }, 100)
      }
    }
    var b = jQuery("#toggle_page_builder").parent().width(), b = b - 48;
    ja = parseInt((b - 120) / 12);
    ...
    jQuery("#major-publishing-actions").before(b);
  ...
  if (jQuery(".rockthemes-pb-save-container").length) {
    var xa = jQuery(".rockthemes-pb-save-container").offset();
    jQuery(window).scroll(function() {
      jQuery(window).scrollTop() > xa.top ? jQuery(".rockthemes-pb-save-container").addClass("sticky") : jQuery(".rockthemes-pb-save-container").hasClass("sticky") && jQuery(".rockthemes-pb-save-container").removeClass("sticky");
    });
  }
  jQuery(document).on("click", ".rockthemes-pb-add-element-main-button", function() {
    ...
    jQuery("#rockthemes-pb-elements-modal").modal();
  });
  jQuery(document).on("click", ".rockthemes-pb-columns-list .col", function() {
    var a = jQuery(this).index(), b = jQuery(this).parent(), c = 0;
    ...
    if (!jQuery(this).hasClass("disabled")) {
      ...
      if (!(0 > jQuery(".rock-builder-template-list").length)) {
        ...
        if (!(0 > jQuery(".rock-builder-template-list").find(":selected").length) && "no_template" != b.val()) {
          ...
          var b = jQuery(".rock-builder-actions").attr("ref"), d = y(b, !1, !0);
  ...
  jQuery(document).on("click", ".add_new_template_button", function() {
    ...
    if (a && "" != a && !jQuery(this).hasClass("disabled")) {
      var b = jQuery(this);
      b.addClass("disabled");
      var c = jQuery(".rock-builder-actions").attr("ref"), d = y(c, !1, !0), e = rockAjax.nonces.rpb_save_nonce;
  ...
  jQuery(document).on("click", ".delete_current_template_button", function() {
    ...
    if (a && "" != a && !jQuery(this).hasClass("disabled")) {
      var b = jQuery(this);
      b.addClass("disabled");
      var a = jQuery(".rock-builder-template-list").find(":selected").val(), c = jQuery(".rock-builder-actions").attr("ref");
  ...
  jQuery(document).on("click", ".load_current_template_button", function() {
    ...
    if ("no_template" != a && !jQuery(this).hasClass("disabled")) {
      ...
      var a = parseInt(a.toString().replace("rock_builder_template_", "")), b = jQuery(".rock-builder-actions").attr("ref"), c = y(b, !1, !0);
  ...
  var ka, J = !0, la;
  wp.media.editor && (la = wp.media.editor.send.attachment);
  jQuery(document).on("click", ".image_uploader_class", function(a) {
    a = jQuery(this);
    ka = jQuery(this).parent().find(".upload_image_button").attr("id");
    J = !0;
    wp.media.editor.send.attachment = function(a, c) {
      if (J) {
        jQuery("#" + ka).val(c.url);
      } else {
        return la.apply(this, [a, c]);
      }
    };
  ...
  var n;
  n = jQuery(".gridster ul").gridster({widget_selector:".gridsterli", widget_margins:[5, 5], widget_base_dimensions:[ja, 50], max_size_x:12, min_rows:12, serialize_params:function(a, b) {
    return {col:b.col, row:b.row, size_x:b.size_x, size_y:b.size_y, id:b.id};
  }}).data("gridster");
  var ma = jQuery("gridster li").length;
  (function() {
  ...
  jQuery(document).on("click", ".rock-tinymce-switch-html", function() {
    var a;
    a = jQuery(this).parents(".rock-tinymce-container").hasClass("tmce-active") ? tinyMCE.activeEditor.getContent() : jQuery(this).parents(".rock-tinymce-container").find(".rock-tinymce-textarea").val();
  ...
  jQuery(document).on("click", ".rock-tinymce-switch-text", function() {
    ...
    var a = jQuery(this).parents(".rock-tinymce-container").find(".rock-tinymce-textarea");
  ...
  jQuery(document).on("click", ".add-element-in-grid-btn", function() {
    3 <= jQuery(this).parent().find(".builder-element").length && 3 == parseInt(jQuery(this).parent().parent().attr("data-sizey")) ? alert("You can not add more than 3 elements to grid") : (jQuery("#rockthemes-pb-elements-modal").addClass("without_columns").attr("grid_elem_id", jQuery(this).parent().parent().attr("id")), jQuery("#rockthemes-pb-elements-modal").modal());
  });
  jQuery(document).on("click", ".element-copy-btn", function() {
    2 < jQuery(this).parent().parent().parent().parent().find(".builder-element").length ? alert("You can not add more than 3 elements to grid") : N(jQuery(this).parent().parent().parent());
  });
  ...
  jQuery(document).on("click", "#add-element-element.rockthems-pb-elements-list > li", function() {
    ...
    jQuery("#rockthemes-pb-elements-modal").modal("hide");
    jQuery("#rockthemes-pb-elements-modal .rockthemes-pb-columns-list .col.selected").removeClass("selected");
    if ("specialgridblock" === a) {
      pa();
    } else {
      var c = jQuery.fn.makeUniqueID(), d = jQuery.fn.makeUniqueElemID(), e;
      e = '<div id="elem-' + d + '" class="builder-element" elem-type="' + a + '"><div class="hide secret-desc"></div><div class="elem-content"><span class="elem-name"><i class="drag fa fa-move"></i> ' + M(a) + '</span><span class="alignright"><i class="fa fa-edit icon-black element-edit-btn"></i><i class="fa fa-copy element-copy-btn"></i><i class="fa fa-times icon-black element-remove-btn"></i></span><div class="clear"></div></div></div>';
      ...
      "" === jQuery("#rockthemes-pb-elements-modal").attr("grid_elem_id") && ua("grid-" + c);
      ...
      "") : "googlemap" == a ? jQuery.fn.addGoogleMapModal("modal-" + d, a, "") : "promotionbox" == a ? jQuery.fn.addPromotionBoxModal("modal-" + d, a, "") : "alertbox" == a ? jQuery.fn.addAlertBoxModal("modal-" + d, a, "") : "referencesbuilder" == a ? jQuery.fn.addReferencesBuilderModal("modal-" + d, a, "") : "testimonialsbuilder" == a ? jQuery.fn.addTestimonialsBuilderModal("modal-" + d, a, "") : "socialicons" == a ? jQuery.fn.addSocialIconsModal("modal-" + d, a, "") : "teammembers" == a ? jQuery.fn.addTeamMembersModal("modal-" + 
      d, a, "") : "beforeafterslider" == a ? jQuery.fn.addBeforeAfterSliderModal("modal-" + d, a, "") : "externalshortcode" == a ? jQuery.fn.addExternalShortcodeModal("modal-" + d, a, "") : "regularblog" == a ? jQuery.fn.addRegularBlogModal("modal-" + d, a, "") : "gallery" == a ? jQuery.fn.addGalleryModal("modal-" + d, a, "") : jQuery.fn.addChosenElementModal("modal-" + d, a, ""));
      "" === jQuery("#rockthemes-pb-elements-modal").attr("grid_elem_id") ? n.add_widget(e, parseInt(b), 3) : (a = L(a, d), jQuery("#" + jQuery("#rockthemes-pb-elements-modal").attr("grid_elem_id")).find(".grid-content").append(a.html));
      jQuery(".grid-content").sortable({connectWith:".grid-content", handle:"i.drag", items:".builder-element", revert:!0, helper:function() {
        return '<div class="sortable-drag-helper"><i class="fa fa-magnet"></i></div>';
      }, receive:function(a, b) {
        jQuery(this).parents(".gridsterli.sortable-parent-index").hasClass("sortable-parent-index") && jQuery(this).parents(".gridsterli.sortable-parent-index").removeClass("sortable-parent-index");
  ...
  jQuery(document).on("click", ".gridster li i.columns-minus", function() {
    ...
    1 > a - 1 || (--a, jQuery(this).parent().parent().find("span.columns-num").html(a), n.resize_widget(jQuery(this).parent().parent(), a, 3));
  });
  jQuery(document).on("click", ".gridster li i.columns-plus", function() {
    ...
    if (!(12 < a + 1)) {
      ...
      12 < a + b ? alert("You should move this element in order to change its size bigger") : (a += 1, jQuery(this).parent().parent().find("span.columns-num").html(a), n.resize_widget(jQuery(this).parent().parent(), a, 3), n.set_dom_grid_height());
    }
  });
  ...
  jQuery(document).on("click", ".columns-remove-btn", function() {
    ...
    z = jQuery(this).parent().parent().parent().attr("id");
    var a = jQuery(this).parent().parent().parent();
    confirm("Are you sure you want to delete this grid column?") && (null != z && (jQuery("#" + z).find(".builder-element").each(function(a) {
      f ? F(jQuery(this).attr("id").toString().replace("elem-", "modal-")) : jQuery("#" + jQuery(this).attr("id").toString().replace("elem-", "modal-")).remove();
      jQuery(this).remove();
    }), f ? F(z.replace("elem-", "modal-")) : jQuery("#" + z.replace("elem-", "modal-")).remove()), n.remove_widget(a));
  });
  jQuery(document).on("click", ".element-remove-btn", function() {
    var a = jQuery(this).parent().parent().parent().attr("id");
    confirm("Are you sure you want to delete this element?") && null != a && (f ? F(a.replace("elem-", "modal-")) : jQuery("#" + a.replace("elem-", "modal-")).remove(), jQuery(this).parent().parent().parent().remove());
  });
  jQuery(document).on("click", ".builder-element", function(a) {
    if (!(jQuery(a.target).attr("class") && -1 < jQuery(a.target).attr("class").toString().indexOf("element-remove-btn") || jQuery(a.target).attr("class") && -1 < jQuery(a.target).attr("class").toString().indexOf("element-copy-btn") || jQuery(a.target).attr("class") && -1 < jQuery(a.target).attr("class").toString().indexOf("drag")) && (a = jQuery(this), a.attr("id"))) {
      ...
      if (0 < a.find("div.secret-desc").length) {
        ...
        c = a.attr("id").split("-"), jQuery("#modal-" + c[1]).modal();
      }
      na = a.attr("id");
    }
  });
  ...
  jQuery(document).on("click", "#save-textarea-data", function() {
    var a = "#" + jQuery(this).parent().parent().attr("id"), a = jQuery(a).find(".rock-tinymce-container").hasClass("tmce-active") ? tinyMCE.activeEditor.getContent() : jQuery(a).find(".rock-tinymce-textarea").val();
    jQuery("#" + na).find(".secret-desc").empty().append(a);
    jQuery("#" + jQuery(this).parent().parent().attr("id")).modal("hide");
  });
  ...
  jQuery.fn.addTextField = function(a, b) {
    var c = '<div id="' + a + '" modalType="textfield" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true"><div class="modal-header"><button type="button" class="close" data-dismiss="modal" aria-hidden="true">\u00d7</button><h3 id="myModalLabel">Modal header</h3></div><div class="modal-body"><textarea rows="10" cols="50" style="width:100%"></textarea></div><div class="modal-footer"><button class="btn" data-dismiss="modal" aria-hidden="true">Close</button><div class="btn btn-primary text-field-save">Save changes</div></div>';
  ...
  jQuery(document).on("change", ".image_sizes", function() {
    if (jQuery(this).parent().parent().attr("calc") && "true" == jQuery(this).parent().parent().attr("calc")) {
      ...
      if ("no-selected" != b.val()) {
        var b = b.attr("sizes"), b = b.split("x"), b = parseInt(b[0]) + 12, c = parseInt(jQuery(".main_page_builder").attr("layout_width")), d = jQuery("#" + a).find(".boxed_layout").is(":checked") ? "true" : "false", e = jQuery("#" + a.replace("modal", "elem")).parent().parent(), e = c / 12 * parseInt(e.attr("data-sizex")), f = parseInt(jQuery(".main_page_builder").attr("layout_padding")), c = 2 * (2 * f - 3) + 2 * (f - 12) - 16.25;
        d || (c -= 2 * (2 * f - 3));
        d = Math.ceil((e - c) / b);
        0 == d && (d = 1);
        12 < d && (d = 12);
  ...
  jQuery(document).on("click", ".add-new-image", function() {
    ...
    jQuery("#" + a + " .images_holder").append(ra(a));
  });
  ...
  jQuery(document).on("click", ".swiperslider-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (Q(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".pt-add-new-package", function() {
    ...
    var c = parseInt(jQuery("#" + a + " .pt-demo .span2").not(".main-details").last().find(".pricing-table-button").attr("id-ref")) + 1, c = '<div class="span2 table-elem"><input autocomplete="off" type="text" name="package_name" class="pt-package-name" value="Standard" data-toggle="tooltip" data-placement="bottom" title="Enter your package name (i.e. Basic, Platinum, Gold)" /><input autocomplete="off" type="text" name="package_detail" class="pt-package-detail" value="Classic Plan" data-toggle="tooltip" data-placement="bottom" title="Enter your package small detail (i.e. Classic Plan)" /><div class="set_featured_holder" style="padding:6px 0px 2px;" data-toggle="tooltip" data-placement="bottom" title="Set featured package (You can only set one featured package)"><label for="set_featured"><input autocomplete="off" type="checkbox" value="1" class="set_featured" name="set_featured" ref="' + 
  ...
  jQuery(document).on("click", ".curvyslider-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (S(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".toggles-block .toggle-name", function() {
    if (!(0 < jQuery("#toggles-single-modal").length)) {
      ...
      jQuery("#toggles-single-modal").modal();
  ...
  jQuery(document).on("click", ".toggles-single-save", function() {
    var a = jQuery(this).attr("modal-ref"), b = parseInt(jQuery(this).attr("ref")), c = jQuery("#toggles-single-modal"), d = q("#" + c.attr("id")), c = c.find(".toggle_header").val(), e = jQuery("#toggles-single-modal").find(".elem-icon .icon-holder").attr("icon-ref"), f = jQuery("#toggles-single-modal").find(".add-elem-icon-text").val();
    ...
    m(jQuery(this).parent().parent());
  });
  jQuery(document).on("click", ".modal .close-toggle-single", function() {
    m(jQuery(this).parent().parent());
  });
  jQuery(document).on("click", ".toggles-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (U(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("hover", ".modal .tabs-block", function() {
  ...
  jQuery(document).on("click", ".tabs-elements-holder .add-new-tab-btn", function() {
    var a = jQuery(this).attr("ref"), b = jQuery("#" + a + " .tabs-block").length, b = '<li class="tabs-block"><div class="hide secret-desc" tab-title="Tabs Awesome" icon_class="" icon_url="">Tab Awesome Content</div><i class="drag fa fa-move"></i><span class="tab-name" ref="' + a + '" tab-index="' + b + '">Tabs Awesome</span><i class="close fa fa-times"></i></li>';
  ...
  jQuery(document).on("click", ".tabs-block .tab-name, .tab-textarea-holder", function() {
    if (!(0 < jQuery("#tabs-single-modal").length)) {
      ...
      jQuery.post(rockAjax.ajaxurl, {tab_obj:g, action:"rock_make_single_tab_modal"}, function(a) {
        jQuery("#modal-holder").append(a);
        jQuery("#tabs-single-modal").modal();
  ...
  jQuery(document).on("click", ".tabs-single-save", function() {
    var a = jQuery(this).attr("modal-ref"), b = parseInt(jQuery(this).attr("ref")), c = jQuery("#tabs-single-modal"), d = q("#" + c.attr("id")), c = c.find(".tab_header").val(), e = "undefined" != jQuery("#tabs-single-modal").find(".elem-icon .icon-holder").attr("ref") ? jQuery("#tabs-single-modal").find(".elem-icon .icon-holder").attr("icon-ref") : "", f = "undefined" != jQuery("#tabs-single-modal").find(".add-elem-icon-text").val() ? jQuery("#tabs-single-modal").find(".add-elem-icon-text").val() : 
    "";
  ...
  jQuery(document).on("click", ".modal .close-tab-single", function() {
    m(jQuery(this).parent().parent());
  });
  jQuery(document).on("click", ".tabs-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (V(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".iconictext-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (W(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".advanced_details_make_button_modal", function() {
    ...
    jQuery.post(rockAjax.ajaxurl, {id:a, ajax_object:b, action:"xr_make_button_modal"}, function(b) {
      null != b && (jQuery("#modal-holder").append(b), jQuery("#" + a).modal());
    });
  });
  jQuery(document).on("click", ".save-remove-button-modal", function() {
    var a = jQuery(this).attr("return_to"), b = jQuery(this).attr("return_data_to"), c = D(jQuery(this).parent().parent().attr("id"));
  ...
  jQuery(document).on("click", ".button-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (D(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".button-skill-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (H(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".rockformbuilder-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (Y(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".googlemap-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (Z(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".promotionbox-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (aa(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".alertbox-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (ba(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".referencesbuilder-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (ca(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("hover", ".modal .testimonialsbuilder-block", function() {
  ...
  jQuery(document).on("click", ".testimonialsbuilder-block .testimonialsbuilder-name, .testimonialsbuilder-textarea-holder", function() {
    if (!(0 < jQuery("#testimonialsbuilder-single-modal").length)) {
      ...
      jQuery.post(rockAjax.ajaxurl, {testimonials_obj:e, action:"rock_make_single_testimonialsbuilder_modal"}, function(a) {
        jQuery("#modal-holder").append(a);
        jQuery("#testimonialsbuilder-single-modal").modal();
  ...
  jQuery(document).on("click", ".testimonialsbuilder-single-save", function() {
    var a = jQuery(this).attr("modal-ref"), b = jQuery(this).attr("ref"), c = jQuery("#testimonialsbuilder-single-modal"), d = q("#" + c.attr("id")), e = c.find(".testimonialsbuilder_header").val(), c = c.find(".company").val();
  ...
  jQuery(document).on("click", ".modal .close-testimonialsbuilder-single", function() {
    m(jQuery(this).parent().parent());
  });
  jQuery(document).on("click", ".testimonialsbuilder-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (da(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("hover", ".modal .socialicons-block", function() {
  ...
  jQuery(document).on("click", ".socialicons-elements-holder .add-new-socialicons-btn", function() {
    var a = jQuery(this).attr("ref"), b = jQuery("#" + a + " .socialicons-block").length, b = '<li class="socialicons-block"><div class="hide secret-desc" socialicons-title="http://www.yahoo.com" icon_class="" icon_url=""></div><i class="drag fa fa-move"></i><span class="socialicons-name" ref="' + a + '" socialicons-index="' + b + '">http://www.yahoo.com</span><i class="close fa fa-times"></i></li>';
  ...
  jQuery(document).on("click", ".socialicons-block .socialicons-name", function() {
    if (!(0 < jQuery("#socialicons-single-modal").length)) {
      ...
      jQuery.post(rockAjax.ajaxurl, {socialicons_obj:f, action:"rock_make_single_socialicons_modal"}, function(a) {
        jQuery("#modal-holder").append(a);
        jQuery("#socialicons-single-modal").modal();
      });
    }
  });
  ...
  jQuery(document).on("click", ".modal .close-socialicons-single", function() {
    m(jQuery(this).parent().parent());
  });
  jQuery(document).on("click", ".save-remove-socialicons-modal", function() {
    var a = jQuery(this).attr("return_to"), b = jQuery(this).attr("return_data_to"), c = I(jQuery(this).parent().parent().attr("id"), !0);
    jQuery("#" + a).val(c.shortcode);
    jQuery("#" + b).val(JSON.stringify(c));
    m(jQuery(this).parent().parent());
  });
  jQuery(document).on("click", ".socialicons-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (I(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("hover", ".modal .teammembers-block", function() {
  ...
  jQuery(document).on("click", ".teammembers-block .teammembers-name", function() {
    if (!(0 < jQuery("#teammembers-single-modal").length)) {
      ...
      jQuery.post(rockAjax.ajaxurl, {teammembers_obj:e, action:"rock_make_single_teammembers_modal"}, function(a) {
        jQuery("#modal-holder").append(a);
        jQuery("#teammembers-single-modal").modal();
  ...
  jQuery(document).on("click", ".teammembers-single-save", function() {
    var a = jQuery(this).attr("modal-ref"), b = jQuery(this).attr("ref"), c = jQuery("#teammembers-single-modal"), d = q("#" + c.attr("id")), e = c.find(".teammembers_header").val(), f = c.find(".company").val(), g = c.find(".external_url").val(), l = c.find(".social_data").val(), k = c.find(".social_shortcode").val(), c = c.find(".member_image_url").val();
    ...
    jQuery("#" + a + " .teammembers-list .teammembers-block").eq(b).find(".social_data").html(l);
    jQuery("#" + a + " .teammembers-list .teammembers-block").eq(b).find(".social_shortcode").html(k);
    jQuery("#" + a + " .teammembers-textarea-holder > div").html(d);
    m(jQuery(this).parent().parent());
  });
  jQuery(document).on("click", ".modal .close-teammembers-single", function() {
    m(jQuery(this).parent().parent());
  });
  jQuery(document).on("click", ".teammembers-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (ea(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".beforeafterslider-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (fa(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".externalshortcode-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (ga(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".regularblog-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (ha(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", ".gallery-modal-save", function() {
    var a = jQuery(this).parent().parent().attr("id");
    f ? l(jQuery("#" + a)) : (ia(a), jQuery("#" + a).modal("hide"));
  });
  ...
  jQuery(document).on("click", '[data-dismiss="modal"]', function(a) {
    a.preventDefault();
    jQuery(this).parents(".modal").length && jQuery(this).parents(".modal").modal("hide");
  });
  if (f) {
    jQuery(document).on("hidden", ".modal", function(a) {
      if ("undefined" == typeof a || jQuery(a.target).hasClass("modal")) {
        var b = jQuery(this);
  ...
  jQuery(document).on("click", ".add-elem-icon-btn", function() {
    ...
    jQuery.post(rockAjax.ajaxurl, {action:"rock_icon_list_modal"}, function(b) {
      ...
      jQuery("#rock-icon-list-modal").modal();
      A = function(b) {
        if ("" != b.icon) {
  ...
  jQuery(document).on("click", ".rock-choose-icon", function() {
    A && A({icon:jQuery(this).attr("ref"), url:""});
    m(jQuery("#rock-icon-list-modal"));
  });
  jQuery(document).on("click", ".iconlist-save", function() {
    A && A({icon:"", url:jQuery("#rock-icon-list-modal .upload_image_button").val()});
    m(jQuery("#rock-icon-list-modal"));
  });
  jQuery.fn.sendAjax = function(a) {
    if (a && !jQuery("#save-current-settings-btn").hasClass("disabled")) {
      var b = jQuery("#save-current-settings-btn").html();
      jQuery("#save-current-settings-btn").addClass("disabled").html(b + " <i class='fa fa-refresh fa-spin'></i>");
      y(a);
    }
  };
  ...
  jQuery.fn.makeUniqueID = function() {
    if (0 < jQuery("#grid-" + t).length) {
      for (;0 < jQuery("#grid-" + t).length;) {
        if (t++, 0 >= jQuery("#grid-" + t).length) {
          return t;
        }
      }
    } else {
  ...
  jQuery.fn.makeSpecialUniqueID = function() {
    if (0 < jQuery("#specialgridblock-open-" + u).length) {
      for (;0 < jQuery("#specialgridblock-open-" + u).length;) {
        if (u++, 0 >= jQuery("#specialgridblock-open-" + u).length) {
          return u;
        }
      }
    } else {
  ...
  jQuery.fn.makeUniqueElemID = function() {
    if (0 < jQuery("#elem-" + v).length) {
      for (;0 < jQuery("#elem-" + v).length;) {
        if (v++, 0 >= jQuery("#elem-" + v).length) {
          return v;
        }
      }
    } else {
  ...
  jQuery(document).on("click", "#send_content_to_tinymce", function() {
    var a = y(jQuery(this).attr("postID"), !0);
...
(function(l, k) {
  l.fn.cloneSelects = function(k, B) {
    var w = this.clone(k, B), q = l("select", this), x = l("select", w);
    q.each(function(k) {
      x.eq(k).val(l(this).val());
    });
    return w;
  };
})(jQuery);