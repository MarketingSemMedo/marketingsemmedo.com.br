...
*/
	...
	function quasar_hover_effect($postID,$insert_shadow = false, $activate_link = true){
		...
		if(isset($rockthemes_advanced_details['video_iframe_code']) && $rockthemes_advanced_details['video_iframe_code'] != ''){
			$return .=
				'
						<a href="'.$rockthemes_advanced_details['video_iframe_code'].'" rel="prettyPhoto" class="iconeffect">
			...
			$return .= '			
						<a href="'.$full_image[0].'" rel="prettyPhoto" class="iconeffect">
