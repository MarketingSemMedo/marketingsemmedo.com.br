			...
			<div class="row">
                ...
                <div class="large-9 columns large-centered">
                    ...
                    <ul>
                        ...
                        <li><?php _e('Forget that this ever happened, and go to our ','icemagtheme'); ?><a href="<?php echo home_url(); ?>"><?php _e('home page','quasar'); ?> <i class="fa-angle-double-right"></i></a></li>
                    </ul>
                    <div class="vertical-space-big"></div>
                </div>
